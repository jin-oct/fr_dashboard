...
OIL_EXACT_NORMALIZED = {
    ...
    "WTI", "WTIOILUSDC", "BRENT", "BRENTOIL",
}
OIL_EXACT_RAW = {"CL", "CL-USD", "WTI", "WTIOIL-USDC", "BRENT", "BRENTOIL"}
BTC_EXACT = {"BTC", "XBT"}
ETH_EXACT = {"ETH"}
SOL_EXACT = {"SOL"}
XAG_EXACT = {"XAG"}
...
ALLOWED_NORMALIZED_SYMBOLS = {
    ...
    "oil": {"CL", "CLUSD", "CLUSD1", "CLUSDT", "CLUSDTPERP", "WTI", "WTIOILUSDC", "BRENT", "BRENTOIL"},
